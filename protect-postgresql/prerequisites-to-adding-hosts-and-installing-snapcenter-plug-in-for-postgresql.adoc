...
* Java 17（SnapCenter 6.2.1 以降の場合）または Java 11（SnapCenter 6.2 以前の場合）をホストにインストールしておく必要があります。
+
...
* Java 17（SnapCenter 6.2.1 以降の場合）または Java 11（SnapCenter 6.2 以前の場合）を Windows ホストにインストールしている必要があります。
+
...
* rootユーザまたはroot以外のユーザに対してパスワードベースのSSH接続を有効にしておく必要があります。
* Java 17（SnapCenter 6.2.1 以降）または Java 11（SnapCenter 6.2 以前）を Linux ホストにインストールしておく必要があります。
+
link:https://www.oracle.com/java/technologies/downloads/#java17["すべてのオペレーティング システム用の Java をダウンロード"]
