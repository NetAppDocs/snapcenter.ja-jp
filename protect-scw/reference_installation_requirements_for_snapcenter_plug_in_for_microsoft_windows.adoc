...
---
= Microsoft Windows用 SnapCenter プラグインのインストール要件
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
サポートされているバージョンに関する最新情報については、 https://imt.netapp.com/imt/imt.jsp?components=180332;134509;180321;180339;&solution=1257&isHWU&src=IMT["NetApp Interoperability Matrix Tool"^] 。
