...
Windows Server では、 SnapCenter プロビジョニングとデータ保護がサポートされます。サポートされているバージョンの最新情報については、を参照してください http://mysupport.netapp.com/matrix["NetApp Interoperability Matrix Tool で確認できます"^]。
...
VMware VM
 a| 
VMFS または NFS データストア上の Virtual Machine File Systems （ VMFS ）
 a| 
VMware vSphere または VSC のクローニングユーティリティ
 a| 
