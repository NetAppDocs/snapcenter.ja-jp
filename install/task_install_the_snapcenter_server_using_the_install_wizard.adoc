...
---
= Windows ホストへの SnapCenter サーバーのインストール
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
オプションで、PowerShellコマンドレットを使用していくつかのインストールおよび構成手順を実行できます。PowerShell 7.4.13以降を使用する必要があります。
...
** です。 NET拡張性4.5
** アプリケーションの初期化
** ASP.NET Core 10.0.7 Hosting Bundle （以降）特定の SnapCenter バージョンに対応した最新の適格 ASP.NET Core バージョンについては、link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3359467["SnapCenter Software Release Notes"^] を参照してください。
** サーバー側インクルード
** WebSocketプロトコル
...
+
** TCPのアクティブ化
** HTTP Activation については、特定の SnapCenter バージョンに対応した最新の ASP.NET Core の認定バージョンを link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3359467["SnapCenter Software Release Notes"^] で確認してください。
