...
---
= SnapCenter VMware環境でのストレージ プロビジョニング
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:https://techdocs.broadcom.com["Broadcom技術ドキュメント"^]を参照し、物理ホスト間での仮想マシンのクラスタリングと、Microsoft クラスタ用の共有 FC RDM LUN の作成に関するドキュメントを検索します。
