...
---
= SnapCenter を使用して SQL Server データベースのバックアップからクローンを作成する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
EMSについては、 https://docs.netapp.com/us-en/snapcenter/admin/concept_manage_ems_data_collection.html["SnapCenter で EMS データ収集を管理する"]を参照してください。
