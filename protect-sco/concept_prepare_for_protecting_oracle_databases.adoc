...
* インストールユーザ用に、認証モードを Linux または AIX に設定してクレデンシャルを作成します。 link:../protect-sco/task_set_up_credentials_for_installing_the_plug_in_package_for_linux_or_aix.html["詳細はこちら。"^]
...
+
を参照してください link:../protect-sco/reference_host_requirements_for_installing_the_snapcenter_plug_in_package_for_linux.html["Linux ホストの要件"^] または  を参照してください。
