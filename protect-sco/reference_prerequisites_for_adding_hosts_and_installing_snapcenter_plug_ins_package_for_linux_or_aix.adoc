...
* Java 17 をインストールする必要があります（SnapCenter 6.2.1 以降）または
* Linux または AIX ホスト上の Java 11（SnapCenter 6.2 以前の場合）。
+
...
必要なソフトウェアパッケージ
 a| 
* SnapCenter 6.2.1以降の場合はJava 17（OracleまたはOpenJDK）、または
* SnapCenter 6.2以前用のJava 11
...
必要なソフトウェアパッケージ
 a| 
* IBM Java 17 for SnapCenter 6.2.1 以降または
* SnapCenter 6.2以前のIBM Java 11
