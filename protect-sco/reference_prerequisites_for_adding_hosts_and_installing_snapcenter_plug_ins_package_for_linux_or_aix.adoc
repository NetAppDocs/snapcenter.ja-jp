...
* Linux または AIX ホストに Java 17、Java 11（SnapCenter 6.2 のみ）をインストールしておく必要があります。
+
...
NOTE: Linuxホスト上にJava 17、Java 11（SnapCenter 6.2のみ）の認定版のみをインストールしていることを確認してください。
...
必要なソフトウェアパッケージ
 a| 
Java 17（Oracle または OpenJDK）、Java 11（SnapCenter 6.2のみ）
...
必要なソフトウェアパッケージ
 a| 
IBM Java 17、IBM Java 11（SnapCenter 6.2のみ）
