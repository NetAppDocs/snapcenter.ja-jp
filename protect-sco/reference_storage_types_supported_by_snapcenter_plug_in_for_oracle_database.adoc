...
|===
。 https://imt.netapp.com/matrix/imt.jsp?components=105283;&solution=1259&isHWU&src=IMT["NetApp Interoperability Matrix Tool で確認できます"] サポートされているバージョンに関する最新情報が含まれています。
