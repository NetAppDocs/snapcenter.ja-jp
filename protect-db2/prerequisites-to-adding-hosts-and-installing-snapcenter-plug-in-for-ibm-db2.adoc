...
+
link:https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html["Windows用JAVAをダウンロード"^]
...
* rootユーザまたはroot以外のユーザに対してパスワードベースのSSH接続を有効にしておく必要があります。
* Linux または AIX ホストに Java 11 がインストールされている必要があります。
+
link:https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html["Linux用JAVAをダウンロード"^]

+
link:https://developer.ibm.com/languages/java/semeru-runtimes/downloads/?license=IBM["AIX用JAVAをダウンロード"^]
