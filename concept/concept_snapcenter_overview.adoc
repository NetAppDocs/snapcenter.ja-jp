...
+
https://["NetApp Storage Automation Store の略"^]
...
+
REST APIの詳細については、を参照してください https://["REST APIの概要"]。

+
Windowsコマンドレットの詳細については、を参照してください https://["SnapCenter ソフトウェアコマンドレットリファレンスガイド"^]。

+
UNIXコマンドの詳細については、を参照してください https://["SnapCenter ソフトウェアコマンドリファレンスガイド"^]。
...
+
カスタムプラグインはコミュニティでサポートされており、からダウンロードできます https://["NetApp Storage Automation Store の略"^]。
...
SnapCenter ソフトウェア用の MySQL 、 DB2 、 MongoDB カスタムプラグインのサンプルは、からダウンロードできます https://["NetApp Storage Automation Store の略"^]。
