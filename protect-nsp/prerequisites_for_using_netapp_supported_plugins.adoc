...
---
= SnapCenterでNetAppがサポートするプラグインを使用するための前提条件
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* 該当する場合は、プラグインホストに Java 17 （Oracle Java、OpenJDK、または SAP JDK）を SnapCenter 6.2.1 以降向けに、または Java 11 を SnapCenter 6.2 以前向けにインストールしてください。
