...
* Linux、Windows、またはAIXホスト上にJava 17、Java 11（SnapCenter 6.2のみ）をインストールしておく必要があります。
+
...
+
Windows Server 2019 または Windows Server 2016 を SnapCenter Server ホストに使用している場合は、Java 17、Java 11（SnapCenter 6.2 のみ）をインストールする必要があります。
...
必要なソフトウェアパッケージ
 a| 
Java 17、Java 11（SnapCenter 6.2のみ）、IBM Java
