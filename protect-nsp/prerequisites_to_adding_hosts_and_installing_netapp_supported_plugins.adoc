...
* SnapCenter 6.2.1以降では、Java 17（Oracle JavaまたはOpenJDK）をインストールする必要があります。または
* Linux、Windows、またはAIXホスト上のSnapCenter 6.2以前用のJava 11。
+
...
+
Windows Server 2019 または Windows Server 2016 を SnapCenter Server ホストに使用している場合は、SnapCenter 6.2.1 以降には Java 17（Oracle Java または OpenJDK）を、SnapCenter 6.2 以前には Java 11 をインストールする必要があります。
...
必要なソフトウェアパッケージ
 a| 
* SnapCenter 6.2.1以降用のJava 17、IBM Javaまたは
* SnapCenter 6.2以前用Java 11、IBM Java
