...
---
= ホストの追加と SnapCenter プラグインのインストールの前提条件
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Linux、Windows、またはAIXホストに、SnapCenter 6.2.1以降の場合はJava 17（Oracle Java、OpenJDK、またはSAP JDK）を、SnapCenter 6.2以前の場合はJava 11をインストールしておく必要があります。
+
...
+
link:https://www.oracle.com/java/technologies/downloads/#java17["Windows 用 Java をダウンロード"]
...
* Linuxホストに、SnapCenter 6.2.1以降の場合はJava 17（Oracle Java、OpenJDK、またはSAP JDK）を、SnapCenter 6.2以前の場合はJava 11をインストールしておく必要があります。
+
Windows Server 2019 または Windows Server 2016 を SnapCenter サーバーホストとして使用している場合は、SnapCenter 6.2.1 以降には Java 17 （Oracle Java、OpenJDK、または SAP JDK）を、SnapCenter 6.2 以前には Java 11 をインストールする必要があります。

+
link:https://www.oracle.com/java/technologies/downloads/#java17["Linux 用 Java をダウンロード"]

+
https://developer.ibm.com/languages/java/semeru-runtimes/downloads/?license=IBM["AIX 用 Java をダウンロード"]
...
必要なソフトウェアパッケージ
 a| 
* Java 17（SnapCenter 6.2.1以降）、IBM JavaまたはJava 11（SnapCenter 6.2以前）、IBM Java
