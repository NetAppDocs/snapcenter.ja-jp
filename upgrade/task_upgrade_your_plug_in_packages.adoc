...
* ASP.NET Core Runtime 10.0.7 Hosting Bundle （またはそれ以降）および PowerShell 7.6.1 （またはそれ以降）が Windows プラグインホストにインストールされていることを確認してください。
+
...
* SnapCenter 6.2.1以降にはJava 17 （Oracle Java、OpenJDK、またはSAP JDK）、SnapCenter 6.2以前にはJava 11が、WindowsおよびLinuxのプラグインホストにインストールされていることを確認してください。
